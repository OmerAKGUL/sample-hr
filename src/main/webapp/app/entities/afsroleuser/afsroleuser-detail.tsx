    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{afsroleuserEntity.usrid ? afsroleuserEntity.usrid.id : ''}</dd>
          <dt>
            <Translate contentKey="sampleHrApp.afsroleuser.rolecode">Rolecode</Translate>
          </dt>
          <dd>{afsroleuserEntity.rolecode ? afsroleuserEntity.rolecode.id : ''}</dd>
        </dl>
        <Button tag={Link} to="/afsroleuser" replace color="info">
        ...
        &nbsp;
        <Button tag={Link} to={`/afsroleuser/${afsroleuserEntity.id}/edit`} replace color="primary">
