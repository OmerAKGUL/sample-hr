  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sampleHrApp.region.home.createOrEditLabel">
            <Translate contentKey="sampleHrApp.region.home.createOrEditLabel">Create or edit a Region</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : regionEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="regionNameLabel" for="region-regionName">
                  <Translate contentKey="sampleHrApp.region.regionName">Region Name</Translate>
                </Label>
